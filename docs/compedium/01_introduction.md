...
- **Глобальна взаємодія**: через топологію тора кожна клітинка має рівно 8 сусідів, і немає «безпечних» крайових зон. Будь-яка фігура може бути атакована або використана з будь-якого місця.
